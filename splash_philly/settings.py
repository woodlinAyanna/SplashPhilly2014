"""
Django settings for splash_philly project.
...
ROOT_URLCONF = 'splash_philly.urls'

WSGI_APPLICATION = 'splash_philly.wsgi.application'
...
STATICFILES_DIRS = (
    ...
    os.path.join(BASE_DIR, 'splash_philly/static'),
)